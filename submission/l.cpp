...
int done[4]={0,0,0,0}, firstPerson=0, tower=0, jump=0, base_i=-1, base_j=-1,tile=0, tile_i=9, tile_j=9, glow=0, thirdPerson=0, helicopter=0;
...
void levels ()
{
	assignBlocks(0,0,-4.5,-0.5,-4.5,1,0,0,0,0);
	assignBlocks(0,1,-3.5,-0.5,-4.5,1,0,0,0,0);
	assignBlocks(0,2,-2.5,-0.5,-4.5,0,0,0,0,0);
	assignBlocks(0,3,-1.5,-0.5,-4.5,1,1,0.125,1,2);
	assignBlocks(0,4,-0.5,-0.5,-4.5,0,0,0,0,0);
	assignBlocks(0,5,0.5,-0.5,-4.5,0,0,0,0,0);
	assignBlocks(0,6,1.5,-0.5,-4.5,1,0,0,0,0);
	assignBlocks(0,7,2.5,-0.5,-4.5,0,0,0,0,0);
	assignBlocks(0,8,3.5,-0.5,-4.5,1,0,0,0,0);
	assignBlocks(0,9,4.5,-0.5,-4.5,1,0,0,0,0);

	assignBlocks(1,0,-4.5,-0.5,-3.5,1,0,0,0,0);
	assignBlocks(1,1,-3.5,-0.5,-3.5,1,0,0,0,0);
	assignBlocks(1,2,-2.5,-0.5,-3.5,0,0,0,0,0);
	assignBlocks(1,3,-1.5,-0.5,-3.5,0,0,0,0,0);
	assignBlocks(1,4,-0.5,-0.5,-3.5,0,0,0,0,0);
	assignBlocks(1,5,0.5,-0.5,-3.5,0,0,0,0,0);
	assignBlocks(1,6,1.5,-0.5,-3.5,1,0,0,0,0);
	assignBlocks(1,7,2.5,-0.5,-3.5,0,0,0,0,0);
	assignBlocks(1,8,3.5,-0.5,-3.5,1,0,0,0,0);
	assignBlocks(1,9,4.5,-0.5,-3.5,1,0,0,0,0);
	
	assignBlocks(2,0,-4.5,-0.5,-2.5,0,0,0,0,0);
	assignBlocks(2,1,-3.5,-0.5,-2.5,1,3,0.125,0,3);
	assignBlocks(2,2,-2.5,-0.5,-2.5,1,0,0,0,0);
	assignBlocks(2,3,-1.5,-0.5,-2.5,1,0,0,0,0);
	assignBlocks(2,4,-0.5,-0.5,-2.5,1,0,0,0,0);
	assignBlocks(2,5,0.5,-0.5,-2.5,1,0,0,0,0);
	assignBlocks(2,6,1.5,-0.5,-2.5,1,0,0,0,0);
	assignBlocks(2,7,2.5,-0.5,-2.5,0,0,0,0,0);
	assignBlocks(2,8,3.5,-0.5,-2.5,0,0,0,0,0);
	assignBlocks(2,9,4.5,-0.5,-2.5,0,0,0,0,0);

	assignBlocks(3,0,-4.5,-0.5,-1.5,0,0,0,0,0);
	assignBlocks(3,1,-3.5,-0.5,-1.5,0,0,0,0,0);
	assignBlocks(3,2,-2.5,-0.5,-1.5,0,0,0,0,0);
	assignBlocks(3,3,-1.5,-0.5,-1.5,0,0,0,0,0);
	assignBlocks(3,4,-0.5,-0.5,-1.5,1,0,0,0,0);
	assignBlocks(3,5,0.5,-0.5,-1.5,1,0,0,0,0);
	assignBlocks(3,6,1.5,-0.5,-1.5,0,0,0,0,0);
	assignBlocks(3,7,2.5,-0.5,-1.5,0,0,0,0,0);
	assignBlocks(3,8,3.5,-0.5,-1.5,1,3,0.125,0,5);
	assignBlocks(3,9,4.5,-0.5,-1.5,1,0,0,0,0);
	
	assignBlocks(4,0,-4.5,-0.5,-0.5,0,0,0,0,0);
	assignBlocks(4,1,-3.5,-0.5,-0.5,1,2,0.125,1,2);
	assignBlocks(4,2,-2.5,-0.5,-0.5,0,0,0,0,0);
	assignBlocks(4,3,-1.5,-0.5,-0.5,0,0,0,0,0);
	assignBlocks(4,4,-0.5,-0.5,-0.5,1,1,0.125,2,2);
	assignBlocks(4,5,0.5,-0.5,-0.5,0,0,0,0,0);
	assignBlocks(4,6,1.5,-0.5,-0.5,0,0,0,0,0);
	assignBlocks(4,7,2.5,-0.5,-0.5,0,0,0,0,0);
	assignBlocks(4,8,3.5,-0.5,-0.5,1,0,0,0,0);
	assignBlocks(4,9,4.5,-0.5,-0.5,1,0,0,0,0);
	
	assignBlocks(5,0,-4.5,-0.5,0.5,1,0,0,0,0);
	assignBlocks(5,1,-3.5,-0.5,0.5,0,0,0,0,0);
	assignBlocks(5,2,-2.5,-0.5,0.5,0,0,0,0,0);
	assignBlocks(5,3,-1.5,-0.5,0.5,1,0,0,0,0);
	assignBlocks(5,4,-0.5,-0.5,0.5,1,0,0,0,0);
	assignBlocks(5,5,0.5,-0.5,0.5,0,0,0,0,0);
	assignBlocks(5,6,1.5,-0.5,0.5,1,0,0,0,0);
	assignBlocks(5,7,2.5,-0.5,0.5,0,0,0,0,0);
	assignBlocks(5,8,3.5,-0.5,0.5,0,0,0,0,0);
	assignBlocks(5,9,4.5,-0.5,0.5,1,0,0,0,0);
	
	assignBlocks(6,0,-4.5,-0.5,1.5,1,3,0.125,0,3);
	assignBlocks(6,1,-3.5,-0.5,1.5,0,0,0,0,0);
	assignBlocks(6,2,-2.5,-0.5,1.5,0,0,0,0,0);
	assignBlocks(6,3,-1.5,-0.5,1.5,1,0,0,0,0);
	assignBlocks(6,4,-0.5,-0.5,1.5,0,0,0,0,0);
	assignBlocks(6,5,0.5,-0.5,1.5,1,3,0.125,0,4);
	assignBlocks(6,6,1.5,-0.5,1.5,1,0,0,0,0);
	assignBlocks(6,7,2.5,-0.5,1.5,0,0,0,0,0);
	assignBlocks(6,8,3.5,-0.5,1.5,1,0,0,0,0);
	assignBlocks(6,9,4.5,-0.5,1.5,0,0,0,0,0);
	
	assignBlocks(7,0,-4.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,1,-3.5,-0.5,2.5,1,0,0,0,0);
	assignBlocks(7,2,-2.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,3,-1.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,4,-0.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,5,0.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,6,1.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,7,2.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,8,3.5,-0.5,2.5,0,0,0,0,0);
	assignBlocks(7,9,4.5,-0.5,2.5,1,2,0.125,1,1);
	
	assignBlocks(8,0,-4.5,-0.5,3.5,0,0,0,0,0);
	assignBlocks(8,1,-3.5,-0.5,3.5,1,0,0,0,0);
	assignBlocks(8,2,-2.5,-0.5,3.5,0,0,0,0,0);
	assignBlocks(8,3,-1.5,-0.5,3.5,1,0,0,0,0);
	assignBlocks(8,4,-0.5,-0.5,3.5,1,0,0,0,0);
	assignBlocks(8,5,0.5,-0.5,3.5,0,0,0,0,0);
	assignBlocks(8,6,1.5,-0.5,3.5,1,0,0,0,0);
	assignBlocks(8,7,2.5,-0.5,3.5,1,0,0,0,0);
	assignBlocks(8,8,3.5,-0.5,3.5,0,0,0,0,0);
	assignBlocks(8,9,4.5,-0.5,3.5,0,0,0,0,0);
	
	assignBlocks(9,0,-4.5,-0.5,4.5,1,0,0,0,0);
	assignBlocks(9,1,-3.5,-0.5,4.5,1,0,0,0,0);
	assignBlocks(9,2,-2.5,-0.5,4.5,0,0,0,0,0);
	assignBlocks(9,3,-1.5,-0.5,4.5,1,0,0,0,0);
	assignBlocks(9,4,-0.5,-0.5,4.5,1,0,0,0,0);
	assignBlocks(9,5,0.5,-0.5,4.5,0,0,0,0,0);
	assignBlocks(9,6,1.5,-0.5,4.5,1,0,0,0,0);
	assignBlocks(9,7,2.5,-0.5,4.5,1,0,0,0,0);
	assignBlocks(9,8,3.5,-0.5,4.5,1,3,0.125,0,4);
	assignBlocks(9,9,4.5,-0.5,4.5,1,0,0,0,0);
