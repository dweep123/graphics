...
/*int spot(double a, double b, double c, double d, double e, double f){
	...
	glLightf(GL_LIGHT2,GL_SPOT_EXPONENT,27);
...
GLuint _textureId[20]; //The id of the texture
...
GLfloat light_position[] = { blocks[a.block_i][a.block_j].x,blocks[a.block_i][a.block_j].y+40,blocks[a.block_i][a.block_j].z-10,1};
...
void myinit()
{
	...
	delete image11;
	/*Image* image4 = loadBMP("m2.bmp");
	_textureId[4] = loadTexture(image4);
	delete image4;
	Image* image4 = loadBMP("m3.bmp");
	_textureId[4] = loadTexture(image4);
	delete image4;
	Image* image4 = loadBMP("m4.bmp");
	_textureId[4] = loadTexture(image4);
	delete image4;
	Image* image4 = loadBMP("5.bmp");
	_textureId[4] = loadTexture(image4);
	delete image4;
	Image* image4 = loadBMP("m6.bmp");
	_textureId[4] = loadTexture(image4);
	delete image4;*/
}
void score_update()
