...
void display(void)
{
	...
	if(spot_light==1)
	{
		...
		//glEnable(GL_LIGHTING);                         	              // activate light0
		glEnable(GL_LIGHT2);                         	              // activate light0
//GLfloat position = {blocks[a.block_i][a.block_j].block_x,blocks[a.block_i][a.block_j].block_y+7,blocks[a.block_i][a.block_j].block_z,1};
//GLfloat position = {a.rob_x, a.rob_y+7, a.rob_z, 1};
	glPushMatrix();
	printf("%d %d\n",a.block_i,a.block_j);
