...
void display(void)
{
	...
	if(spot_light==1)
	{
	/*	GLfloat lightPos[]={a.rob_x,10.0,a.rob_z,1.0};      	              // set light position
...
//		spot( a.rob_x-3,a.rob_y+5,a.rob_z,a.rob_x,0,a.rob_z);
		...
		GLfloat spotDir[]={0.0,10-a.rob_y,0};            	// define spot direction
		glLightfv(GL_LIGHT0, GL_SPOT_DIRECTION, spotDir);
...
*/
		...
		glEnable(GL_LIGHT0);                         	              // activate light0
		glEnable(GL_LIGHTING);                       	              // enable lighting
		GLfloat lightPos[]={a.rob_x,a.rob_y+5,a.rob_z-10.0,1.0};
		glLightfv(GL_LIGHT0,GL_POSITION,lightPos);

		// set spot light parameters
	//GLfloat spotDir[]={-a.rob_x,a.rob_y,a.rob_z};            	// define spot direction
	GLfloat spotDir[]={a.rob_x,a.rob_y,a.rob_z};            	// define spot direction
	//	GLfloat spotDir[]={0-a.rob_x,10-a.rob_y,-20-a.rob_z};            	// define spot direction
